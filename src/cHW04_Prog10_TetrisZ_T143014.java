 ...
 *
 */
public class cHW04_Prog10_TetrisZ_T143014 extends JFrame {
	int row = 20, col = 25, xo = 30, yo = 30, a = 20, c = 1, d = 1, c1 = 2,c2=3 ,d1 = 2;
	JTextPane txt = new JTextPane();

	JButton left = new JButton("LEFT"), right = new JButton("RIGHT"), down = new JButton("DOWN"),
			up = new JButton("UP");

	public cHW04_Prog10_TetrisZ_T143014() {
		setTitle("Tetris moving (Z) -T143014 ");
		setSize(560, 550);
	...
	public void paint(Graphics g) {
		...
		g.fillRect(xo + c1 * a, yo + d * a, 20, 20);
		g.fillRect(xo + c1 * a, yo + d1 * a, 20, 20);
		g.fillRect(xo + c2 * a, yo + d1 * a, 20, 20);
		g.setColor(Color.yellow);
		g.drawRect(xo + c * a, yo + d * a, 20, 20);
		g.drawRect(xo + c1 * a, yo + d * a, 20, 20);
		g.drawRect(xo + c1 * a, yo + d1 * a, 20, 20);
		g.drawRect(xo + c2 * a, yo + d1 * a, 20, 20);
	...
	public static void main(String[] args) {
		// TODO Auto-generated method stub
		cHW04_Prog10_TetrisZ_T143014 mainWindow = new cHW04_Prog10_TetrisZ_T143014();
