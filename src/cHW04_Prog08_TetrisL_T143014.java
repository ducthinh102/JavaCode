 ...
 *
 */
public class cHW04_Prog08_TetrisL_T143014 extends JFrame {
	int row = 20, col = 25, xo = 30, yo = 30, a = 20, c = 2, d = 1, c1 = 1, d1 = 2, d2 = 3;
	JTextPane txt = new JTextPane();

	JButton left = new JButton("LEFT"), right = new JButton("RIGHT"), down = new JButton("DOWN"),
			up = new JButton("UP");

	public cHW04_Prog08_TetrisL_T143014() {
		setTitle("Tetris moving (L) - T143014 ");
		setSize(560, 550);
		setLayout(null);
		add(left);
		add(right);
	...
	public static void main(String[] args) {
		// TODO Auto-generated method stub
		cHW04_Prog08_TetrisL_T143014 mainWindow = new cHW04_Prog08_TetrisL_T143014();
